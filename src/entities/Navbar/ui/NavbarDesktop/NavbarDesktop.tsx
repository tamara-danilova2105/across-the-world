...
import useOptimizedNavbarScroll from "@/shared/hooks/useOptimizedNavbarScroll";

export const NavbarDesktop = () => {

    const isFixed = useOptimizedNavbarScroll(styles)

    return (
        <Stack
            max 
            align="center"
            className={getStyles(styles.navbar, { [styles.fixed]: isFixed }, [])}
        >
            <Stack 
                max 
                justify='between'
